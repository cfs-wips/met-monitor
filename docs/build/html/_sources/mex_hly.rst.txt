...
.. raw:: html
    ...
    <div class="csv-table-responsive mex-hly-status-wrapper">

.. csv-table:: Mexico Hourly Status - mex_wx_status.csv
   :file: ./_static/mex_wx_status.csv
   :header-rows: 1
   :align: center
...
.. raw:: html
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                makeCsvCellsClickable('.mex-hly-status-wrapper', csvCellClassMexHourly);
            });
        </script>
