...
.. raw:: html
    ...
    <div class="csv-table-responsive usa-hly-status-wrapper">

.. csv-table:: USA Hourly Status - usa_hly_status.csv
   :file: ./_static/usa_hly_status.csv
   :header-rows: 1
   :align: center
...
.. raw:: html
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                makeCsvCellsClickable('.usa-hly-status-wrapper', csvCellClassUSAHourly);
            });
        </script>
