Canadian Synoptic Reports
=========================

Canadian Synoptic reports come in at synoptic hours; 00, 06, 12, and 18 UTC. 
...
.. raw:: html
    ...
    <div class="csv-table-responsive syno-status-wrapper">

.. csv-table:: Canadian Synoptic Report Status - can_synd_status.csv
...
.. raw:: html
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                makeCsvCellsClickable('.syno-status-wrapper', csvCellClassSyno);
            });
        </script>
...
.. raw:: html
        ...
        <div class="disclaimer">
                <strong>Red - XX requires a rerun to gather data. Any non-synoptic hours are greyed out</strong><br>
        </div>

        <div class="disclaimer">
                    <strong>Green - Running well: Any percentage of data is coming in on the synoptic hours.</strong><br>
        </div>